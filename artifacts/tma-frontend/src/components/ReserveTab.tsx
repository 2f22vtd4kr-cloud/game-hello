...
const TIERS = [
  { name: "🚶 Пешеход",          short: "Пешеход",    min: 0,       max: 999    },
  { name: "🚲 Самокатчик",       short: "Самокатчик", min: 1000,   max: 4999   },
  { name: "🛵 Мопедист",         short: "Мопедист",   min: 5000,   max: 14999  },
  { name: "🚗 Извозчик",         short: "Извозчик",   min: 15000,  max: 34999  },
  { name: "🚛 Дальнобойщик",     short: "Дальнобой",  min: 35000,  max: 59999  },
  { name: "⚡ Бензиновый Барон", short: "Барон",      min: 60000,  max: 99999  },
  { name: "👑 Владелец НПЗ",     short: "Владелец НПЗ", min: 100000, max: null },
];
